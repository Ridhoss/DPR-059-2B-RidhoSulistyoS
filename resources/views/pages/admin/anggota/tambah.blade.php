...
@section('content')
    <h1 class="font-bold text-3xl uppercase mt-10 text-center">Tambah Anggota</h1>
                ...
                <div class="flex gap-5">
                    <div class="flex flex-col mt-3 w-full">
                        ...
                        <input type="text" class="border border-gray-500 h-10 rounded-lg ps-2 mt-2" id="nama_depan"
                            name="nama_depan" value="{{ old('nama_depan') }}" placeholder="Nama Depan" required>
                    </div>
                    <div class="flex flex-col mt-3 w-full">
                        <label for="nama_belakang">Nama Belakang</label>
                        <input type="text" class="border border-gray-500 h-10 rounded-lg ps-2 mt-2" id="nama_belakang"
                            name="nama_belakang" value="{{ old('nama_belakang') }}" placeholder="Nama Belakang" required>
                    </div>
                </div>
                <div class="flex flex-col mt-3">
                    <label for="gelar_depan">Gelar Depan</label>
                    <input type="text" class="border border-gray-500 h-10 rounded-lg ps-2 mt-2" id="gelar_depan"
                        name="gelar_depan" value="{{ old('gelar_depan') }}" placeholder="Gelar Depan">
                </div>
                <div class="flex flex-col mt-3">
