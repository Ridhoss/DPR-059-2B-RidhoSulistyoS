...
@section('content')
            ...
            <div class="flex flex-col justify-center items-center w-[70%]">
                <div class="p-5 border-2 border-gray-300 bg-white shadow-xl rounded-lg w-full">
                    <div class="flex flex-col mt-3">
                        ...
                        <input type="text" class="border border-gray-500 h-10 rounded-lg ps-2 mt-2" id="anggota" value="{{ old('anggota') }}"
    ...
    <script>
        ...
        komponenGajiArray.forEach(k => {
            const isChecked = komponenGajiTerpilih.some(kt => kt.id_komponen_gaji == k.id_komponen_gaji);
            ...
            row.innerHTML = /*html*/ `
                        ...
                        <td class="h-full flex gap-2 justify-center items-center">
                            <input class="scale-125" type="checkbox" name="pilihGaji[]" value="${k.id_komponen_gaji}" ${isChecked ? 'checked' : ''}>
                        </td>
                    `;
